...
base_path = os.path.join(
    os.path.split(os.path.realpath(os.path.dirname(__file__)))[0], "datasets/tests"
)

# remote1 = {'bucket': 'ecan-env-monitoring', 'public_url': 'https://b2.tethys-ts.xyz/file/', 'version': 4}
remote2 = {
    "bucket": "nz-open-modelling-consortium",
    "public_url": "https://b2.nzrivers.xyz/file/",
    "version": 4,
}
remote3 = {
    "bucket": "fire-emergency-nz",
